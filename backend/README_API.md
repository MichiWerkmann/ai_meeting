...
Setze `notify_action_items` auf `false`, wenn nur allgemeine Minutes versendet werden sollen und keine Aufgaben-E-Mails pro Owner.
...
- Action-Item-E-Mails werden ueber SMTP verschickt. Relevante Variablen:
  - `ACTION_ITEM_EMAIL_ENABLED=true|false`
  - `SMTP_HOST`, `SMTP_PORT`, `SMTP_USERNAME`, `SMTP_PASSWORD`
  - `SMTP_FROM`, `SMTP_FROM_NAME`, `SMTP_USE_TLS`
  - `ACTION_ITEM_OWNER_EMAIL_MAP` als JSON, z. B. `{"Dennis":"dennis@example.com","Darius":"darius@example.com"}`
  - optional `ACTION_ITEM_DEFAULT_EMAIL_DOMAIN`, um aus Owner-Namen automatisch E-Mails zu bilden.
